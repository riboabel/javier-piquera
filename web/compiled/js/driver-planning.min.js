...
(function(t,o,s){function f(o,e){this.bodyOverflowX;this.callbacks={hide:[],show:[]};this.checkInterval=null;this.Content;this.$el=t(o);this.$elProxy;this.elProxyPosition;this.enabled=!0;this.options=t.extend({},n,e);this.mouseIsOverProxy=!1;this.namespace='tooltipster-'+Math.round(Math.random()*1e5);this.Status='hidden';this.timerHide=null;this.timerShow=null;this.$tooltip;this.options.iconTheme=this.options.iconTheme.replace('.','');this.options.theme=this.options.theme.replace('.','');this._init()};function r(o,e){var i=!0;t.each(o,function(t,n){if(typeof e[t]==='undefined'||o[t]!==e[t]){i=!1;return!1}});return i};function l(){return!a&&e};function i(){var i=s.body||s.documentElement,e=i.style,t='transition';if(typeof e[t]=='string'){return!0};v=['Moz','Webkit','Khtml','O','ms'],t=t.charAt(0).toUpperCase()+t.substr(1);for(var o=0;o<v.length;o++){if(typeof e[v[o]+t]=='string'){return!0}};return!1};var p='tooltipster',n={animation:'fade',arrow:!0,arrowColor:'',autoClose:!0,content:null,contentAsHTML:!1,contentCloning:!0,debug:!0,delay:200,minWidth:0,maxWidth:null,functionInit:function(t,o){},functionBefore:function(t,o){o()},functionReady:function(t,o){},functionAfter:function(t){},hideOnClick:!1,icon:'(?)',iconCloning:!0,iconDesktop:!1,iconTouch:!1,iconTheme:'tooltipster-icon',interactive:!1,interactiveTolerance:350,multiple:!1,offsetX:0,offsetY:0,onlyOne:!1,position:'top',positionTracker:!1,positionTrackerCallback:function(t){if(this.option('trigger')=='hover'&&this.option('autoClose')){this.hide()}},restoration:'current',speed:350,timer:0,theme:'tooltipster-default',touchDevices:!0,trigger:'hover',updateAnimation:!0};f.prototype={_init:function(){var o=this;if(s.querySelector){var i=null;if(o.$el.data('tooltipster-initialTitle')===undefined){i=o.$el.attr('title');if(i===undefined)i=null;o.$el.data('tooltipster-initialTitle',i)};if(o.options.content!==null){o._content_set(o.options.content)}
...
;App=function(){var a,e,r=function(){var a=e.data('driver-url');e.find('select').select2({language:'es',minimunInputLength:1,width:'100%',ajax:{url:a,dataType:'json',delay:250,method:'get',data:function(e){return{q:e.term,page:e.page}}}});e.find('select').on('change',t)},t=function(){var e=$(this).data('save-url');$.ajax(e,{dataType:'json',method:'post',data:{driver:$(this).val()},success:function(e){a.DataTable().draw(!1)}})},n=function(){e=$('table#table-records');e.on('draw.dt',r);a=e.dataTable({aoColumns:[{name:'serrialNumber'},{name:'provider'},{name:'providerReference'},{name:'serviceType'},{name:'serviceDescription'},{name:'startAt'},{name:'endAt'},{name:'driver',sortable:!1}],'language':{'sProcessing':'Procesando...','sLengthMenu':'Mostrar _MENU_ registros','sZeroRecords':'No se encontraron resultados','sEmptyTable':'No hay cobros pendientes','sInfo':'Mostrando del _START_ al _END_ (de _TOTAL_)','sInfoEmpty':'Mostrando registros del 0 al 0 de un total de 0 registros','sInfoFiltered':'(filtrado de un total de _MAX_ registros)','sInfoPostFix':'','sSearch':'Buscar:','sUrl':'','sInfoThousands':',','sLoadingRecords':'Cargando...','oPaginate':{'sFirst':'Primero','sLast':'Último','sNext':'Siguiente','sPrevious':'Anterior'},'oAria':{'sSortAscending':': Activar para ordenar la columna de manera ascendente','sSortDescending':': Activar para ordenar la columna de manera descendente'}},serverSide:!0,bProcessing:!0,ajax:{url:e.data('url'),method:'post',data:function(e){return $.extend(!0,e,{filter:{fromDate:$('#from-date').val(),toDate:$('#to-date').val()}})}}})},o=function(){$('.datepicker').on('change',function(){a.DataTable().draw(!0)});$('.datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0,clearBtn:!0})};return{init:function(){n();o()}}}();