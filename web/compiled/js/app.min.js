...
;App=typeof App!=='undefined'?App:{};App.ReservasClasicos=typeof App.ReservasClasicos!=='undefined'?App.ReservasClasicos:{};+(App.ReservasClasicos.Index=function(e,a){'use strict';var t=e('#dataTables-reservas'),n=function(){t.on('preDraw.dt',function(){e(this).block({message:'Cargando datos...'})}).on('draw.dt',function(){e(this).unblock();e(this).find('input:checkbox').iCheck({checkboxClass:'icheckbox_flat-blue'});e(this).find('tbody [title]').tooltip({'trigger':'hover'})});t.dataTable({ajax:{data:function(t){var a=[];e.each(e('form#formFilter').serializeArray(),function(e,t){a[t.name]=t.value});return e.extend(!0,t,a)},url:a.Routing.generate('app_reservasclasicos_getdata'),method:'GET',error:function(){a.alert('Error obteniendo datos de listado')}},columns:[{sortable:!1,searchable:!1,width:'24px'},{name:'state',title:'Estado',searchable:!1,sortable:!1},{name:'startat',title:'Fecha'},{name:'service',title:'Servicio'},{name:'client',title:'Cliente'},{name:'clientSerial',title:'Referencia del cliente'},{name:'provider',title:'Proveedor'},{name:'providerSerial',title:'Referencia del proveedor'},{name:'clientNames',title:'Nombre(s)'},{name:'pax',title:'Pax'},{searchable:!1,sortable:!1,width:'130px'}],serverSide:!0,searching:!1,sorting:[[2,'asc']]})},i=function(){t.on('click','.btn-delete',function(n){n.preventDefault();var i=e(this).attr('href'),o=e(this);a.swal({showCancelButton:!0,title:'Confirmar eliminación',text:'¿Seguro desea borrar esta reserva?',type:'warning'},function(a){if(a){o.closest('td').text('Eliminando...');e.ajax({method:'POST',success:function(e){t.DataTable().draw(!0)},dataType:'json',url:i})}})});t.on('click','.btn-confirm',function(a){a.preventDefault();var n=e(this).attr('href');e(this).closest('td').empty().text('Confirmando...');e.ajax({method:'POST',url:n,success:function(e){t.DataTable().draw(!0)}})});t.on('click','.btn-execute',function(a){a.preventDefault();e('#_m').remove();var n=e('<div id="_m" class="modal fade" data-backdrop="static"><div class="modal-dialog"><div class="modal-content"/></div></div>');n.modal();n.find('.modal-content').load(e(this).attr('href'),function(){n.find('form').ajaxForm({beforePost:function(){n.find('button:submit').attr('disabled','disabled')},dataType:'json',success:function(e){n.modal('hide');t.DataTable().draw(!0)}})})});t.on('click','.btn-change-state',function(a){a.preventDefault();e('#_m').remove();var n=e('<div id="_m" class="modal fade" data-backdrop="static"><div class="modal-dialog"><div class="modal-content"/></div></div>');n.modal();n.find('.modal-content').load(e(this).attr('href'),function(){n.find('form').ajaxForm({beforePost:function(){n.find('button:submit').attr('disabled','disabled')},dataType:'json',success:function(e){n.modal('hide');t.DataTable().draw(!0)}})})})},o=function(){e('#link-select-all').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('check')});e('#link-select-none').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('uncheck')})},r=function(){e('#formFilter').find('input:text.datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0,closeBtn:!0,language:'es'});e('#formFilter').find('input:text.datepicker').on('changeDate',function(){t.DataTable().draw()});e('#formFilter input:text:not(.datepicker)').on('keyup',function(){t.DataTable().draw()})},c=function(e){if(e.length>0){swal({'title':'Notificaciones','text':e[0].replace(/\\n/g,'\n')})}};return{init:function(e){n();i();o();r();c(e)}}}(jQuery,window));
;App=typeof App!=='undefined'?App:{};App.ReservasGuia=typeof App.ReservasGuia!=='undefined'?App.ReservasGuia:{};+(App.ReservasGuia.Index=function(e,a){'use strict';var t=e('#dataTables-reservas'),n=function(){t.on('preDraw.dt',function(){e(this).block({message:'Cargando datos...'})}).on('draw.dt',function(){e(this).unblock();e(this).find('input:checkbox').iCheck({checkboxClass:'icheckbox_flat-blue'});e(this).find('tbody [title]').tooltip({'trigger':'hover'})});t.dataTable({ajax:{data:function(t){var a=[];e.each(e('form#formFilter').serializeArray(),function(e,t){a[t.name]=t.value});return e.extend(!0,t,a)},url:a.Routing.generate('app_reservasguia_getdata'),method:'GET',error:function(){a.alert('Error obteniendo datos de listado')}},columns:[{sortable:!1,searchable:!1,width:'24px'},{name:'state',title:'Estado',searchable:!1,sortable:!1},{name:'startat',title:'Fecha'},{name:'service',title:'Servicio'},{name:'client',title:'Cliente'},{name:'clientSerial',title:'Referencia del cliente'},{name:'provider',title:'Proveedor'},{name:'providerSerial',title:'Referencia del proveedor'},{name:'clientNames',title:'Nombre(s)'},{name:'pax',title:'Pax'},{searchable:!1,sortable:!1,width:'130px'}],serverSide:!0,searching:!1,sorting:[[2,'asc']]})},i=function(){t.on('click','.btn-delete',function(n){n.preventDefault();var i=e(this).attr('href'),o=e(this);a.swal({showCancelButton:!0,title:'Confirmar eliminación',text:'¿Seguro desea borrar esta reserva?',type:'warning'},function(a){if(a){o.closest('td').text('Eliminando...');e.ajax({method:'POST',success:function(e){t.DataTable().draw(!0)},dataType:'json',url:i})}})});t.on('click','.btn-confirm',function(a){a.preventDefault();var n=e(this).attr('href');e(this).closest('td').empty().text('Confirmando...');e.ajax({method:'POST',success:function(e){t.DataTable().draw(!0)},url:n})});t.on('click','.btn-execute',function(a){a.preventDefault();e('#_m').remove();var n=e('<div id="_m" class="modal fade" data-backdrop="static"><div class="modal-dialog"><div class="modal-content"/></div></div>');n.modal();n.find('.modal-content').load(e(this).attr('href'),function(){n.find('form').ajaxForm({beforePost:function(){n.find('button:submit').attr('disabled','disabled')},dataType:'json',success:function(e){n.modal('hide');t.DataTable().draw(!0)}})})});t.on('click','.btn-change-state',function(a){a.preventDefault();e('#_m').remove();var n=e('<div id="_m" class="modal fade" data-backdrop="static"><div class="modal-dialog"><div class="modal-content"/></div></div>');n.modal();n.find('.modal-content').load(e(this).attr('href'),function(){n.find('form').ajaxForm({beforePost:function(){n.find('button:submit').attr('disabled','disabled')},dataType:'json',success:function(e){n.modal('hide');t.DataTable().draw(!0)}})})})},o=function(){e('#link-select-all').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('check')});e('#link-select-none').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('uncheck')})},r=function(){e('#formFilter').find('input:text.datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0,closeBtn:!0,language:'es'});e('#formFilter').find('input:text.datepicker').on('changeDate',function(){t.DataTable().draw()});e('#formFilter input:text:not(.datepicker)').on('keyup',function(){t.DataTable().draw()})},c=function(e){if(e.length>0){swal({'title':'Notificaciones','text':e[0].replace(/\\n/g,'\n')})}};return{init:function(e){n();i();o();r();c(e)}}}(jQuery,window));
...
else{console.log('Validator plugin not present')}},i=function(){a=App.Main.validate(e('form#reserva'),{rules:{'reserva[startAt]':'validdatetime','reserva[endAt]':'validdatetime endafterstart','reserva[pax]':{min:1}}});e('#reserva_form_startPlace, #reserva_form_endPlace').on('change',function(){e(this).valid()})},s=function(a){a.preventDefault();var i=e('#places-container'),d=i.data('prototype'),s=i.data('index'),r=e(d.replace(/__name__/g,s));i.data('index',s+1);i.append(r);r.find('select').select2(t());r.find('.select2-container').css('width','');r.find('.select2-selection').css('height','30px');r.find('.datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0});if(i.find('.item').length>1){r.find('.datepicker').datepicker('setDate',r.prev().find('.datepicker input').val())};r.find('button.btn-delete').on('click',n)},n=function(t){t.preventDefault();e(this).parents('.item:first').removeClass('item').fadeOut(function(){e(this).remove()})},d=function(){e('#places-container').data('index',e('#places-container .item').length);e('#linkAddPassingPlace').on('click',s);e('#places-container .datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0});e('#places-container').find('button.btn-delete').on('click',n);e('#places-container').find('select').select2(t());e('#places-container').find('.select2-selection').css('height','30px')},t=function(){return{ajax:{url:e('#reserva_form_startPlace').data('ajax'),dataType:'json',delay:250,data:function(e){return{q:e.term,page:e.page}}},language:'es',minimunInputLength:1,placeholder:'Seleccione un lugar',width:'resolve'}},o=function(){if(e.fn.select2){e('#reserva_form_startPlace, #reserva_form_endPlace').select2(t());e('.select2-container').css('width','')}
else{console.log('select2 plugin not present')}},c=function(){e('#reserva_form_isDriverConfirmed, #reserva_form_hasIncompleteData').iCheck({checkboxClass:'icheckbox_flat-blue'});e('.btn-test-printed-version').on('click',function(){var n=e(this).data('target').replace(/^\#/,''),a=CKEDITOR.instances[n].getData(),t=e('<form/>').appendTo(e('body')).attr({action:Routing.generate('app_reservas_testprintedversion'),method:'POST',target:'_blank'}).append(e('<input type="hidden" name="content"/>').val(a));t.submit();t.remove()})};return{init:function(){i();r();d();o();c()}}}(jQuery));
...
;App=typeof App!=='undefined'?App:{};App.ThirdCobros=typeof App.ThirdCobros!=='undefined'?App.ThirdCobros:{};+(App.ThirdCobros.Index=function(e){var t=e('table#services'),n=function(){t.on('preDraw.dt',function(){e(this).block({message:'Cargando datos...'})}).on('draw.dt',function(){e(this).find('input:checkbox').iCheck({checkboxClass:'icheckbox_flat-blue'});e(this).unblock()});t.dataTable({aaSorting:[[2,'asc']],ajax:{data:function(t){var n=[];e.each(e('form#formFilter').serializeArray(),function(e,t){n[t['name']]=t['value']});return e.extend(!0,t,n)},error:function(e){alert('Error cargando datos\n\n'+e.statusText)},method:'GET',url:Routing.generate('app_thirdcobros_getdata')},columns:[{searchable:!1,sortable:!1,width:'22px'},{name:'service',title:'Servicio'},{name:'startat',title:'Fecha'},{name:'provider',title:'Proveedor'},{name:'providerreference',title:'Referencia del proveedor',sortable:!1},{name:'customer',title:'Cliente'},{name:'customerreference',title:'Referencia del cliente'},{name:'state',title:'Estado',searchable:!1,sortable:!1,width:'40px'},{name:'charge',title:'Importe',searchable:!1,sortable:!1}],lengthMenu:[10,50],processing:!1,searching:!1,serverSide:!0})},r=function(){e('a#link-select-all').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('check')});e('a#link-select-none').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('uncheck')});e('#btnPrepareCobro').on('click',function(){var n=e.map(t.find('input:checkbox:checked'),function(t){return e(t).val()});if(n.length===0){toastr.error('Seleccione servicios','Error',{timeout:5000});return!0};e.ajax({error:function(e){toastr.error('Error cargando datos','Error',{timeout:5000})},method:'GET',success:function(t){e.unblockUI();e('div.modal#_dV').remove();var n=e(t).appendTo(e('body')).attr('id','_dV');n.on('hide.bs.modal',function(){n.find('form').remove()});App.Main.validate(n.find('form'),{submitHandler:function(){n.find('form').ajaxSubmit({beforeSubmit:function(){n.find('button[type=submit]').attr('disabled','disabled').text('Creando pago...')},target:n.find('.modal-content')})}});n.modal()},url:Routing.generate('app_thirdcobros_cobrar',{id:n})})});e(document).on('click','.modal-footer .btn-print',function(){var t=e(this).closest('form'),o=t.find('input:text, input:hidden'),r=e('<form/>').attr({action:Routing.generate('app_thirdcobros_printprereport'),method:'POST',target:'_blank'}).appendTo(e('body'));var n=function(t,n){return r.append(e('<input type="hidden"/>').attr('name',t).val(n))};t.find('input:hidden[name^="services]["][name$="][id]"]').each(function(r,o){n('services['+r+'][id]',e(o).val());n('services['+r+'][charge]',t.find('input:text[name$="['+r+'][cobroCharge]"]').val());n('services['+r+'][note]',t.find('input:text[name$="['+r+'][cobroNotes]"]').val())});r.submit().remove()})},o=function(){e('form#formFilter').find('input:text[name$="[startAt][left_date]"], input:text[name$="[startAt][right_date]"]').datepicker({format:'dd/mm/yyyy',autoclose:!0,clearBtn:!0,language:'es'});e('#collapseFilter').find('input, select').on('change',function(){t.DataTable().draw()})};return{init:function(){n();r();o()}}}(jQuery));
;App=typeof App!=='undefined'?App:{};App.ThirdPays=typeof App.ThirdPays!=='undefined'?typeof App.ThirdPays:{};+(App.ThirdPays.Index=function(e){'use strict';var t=e('table#pays'),n=function(){t.on('preDraw.dt',function(){e(this).block({message:'Cargando datos...'})}).on('draw.dt',function(){e(this).find('input:checkbox').iCheck({checkboxClass:'icheckbox_flat-blue'});e(this).unblock()});t.dataTable({aaSorting:[[2,'asc']],ajax:{data:function(t){var n=[];e.each(e('form#formFilter').serializeArray(),function(e,t){n[t['name']]=t['value']});return e.extend(!0,t,n)},error:function(e){alert('Error cargando datos\n\n'+e.statusText)},method:'GET',url:Routing.generate('app_thirdpays_getdata')},columns:[{searchable:!1,sortable:!1,width:'22px'},{name:'service',title:'Servicio'},{name:'startat',title:'Fecha'},{name:'provider',title:'Proveedor'},{name:'providerreference',title:'Referencia del proveedor',sortable:!1},{name:'customer',title:'Cliente'},{name:'customerreference',title:'Referencia del cliente'},{name:'state',title:'Estado',searchable:!1,sortable:!1,width:'40px'},{name:'charge',title:'Importe',searchable:!1,sortable:!1}],processing:!1,serverSide:!0})},a=function(){e('form#formFilter').find('input:text, select').on('change',function(){t.DataTable().draw()});e('form#formFilter').find('input[name$="[startAt][left_date]"], input[name$="[startAt][right_date]"]').datepicker({format:'dd/mm/yyyy',autoclose:!0,clearBtn:!0,language:'es'})},r=function(){e('a#link-select-all').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('check')});e('a#link-select-none').on('click',function(e){e.preventDefault();t.find('input:checkbox').iCheck('uncheck')});e('button#btnPreparePay').on('click',function(){var n=e.map(t.find('input:checkbox:checked'),function(t){return e(t).val()});if(n.length===0){toastr.error('Seleccione servicios','Error',{timeout:5000});return!0};e.blockUI({message:'Cargando datos...'});e.ajax({error:function(t){alert('Error cargando datos\n]n'+t.statusText);e.unblockUI()},method:'GET',success:function(t){e.unblockUI();e('div.modal').remove();var n=e(t).appendTo(e('body'));n.on('hide.bs.modal',function(){n.find('form').remove()});App.Main.validate(n.find('form'),{submitHandler:function(){n.find('form').ajaxSubmit({beforeSubmit:function(){n.find('button[type=submit]').attr('disabled','disabled').text('Creando pago...')},target:n.find('.modal-content')})}});n.modal()},url:Routing.generate('app_thirdpays_pay',{id:n})})})},i=function(){e('body').on('click','.modal-pay button.btn.btn-print-report',function(){var t=e(this).closest('form'),a=t.find('input[name="id[]"]'),n=e('<form/>').attr({action:Routing.generate('app_thirdpays_printprereport'),method:'POST',target:'_blank'}).appendTo(e('body'));a.each(function(a){var r=e(this),i=t.find('input:text[name$="[services]['+a+'][paidCharge]"]'),o=t.find('input:text[name$="[services]['+a+'][payNotes]"]');n.append(e('<input type="hidden"/>').attr('name','ids[]').val(r.val())).append(e('<input type="hidden"/>').attr('name','charges[]').val(i.val())).append(e('<input type="hidden"/>').attr('name','notes[]').val(o.val()))});n.submit();n.remove()})};return{init:function(){n();a();r();i()}}}(jQuery));
