...
;App=typeof App!=='undefined'?App:{};App.Cobros=typeof App.Cobros!=='undefined'?App.Cobros:{};+(App.Cobros.Index=function(o){var e,t=function(){if(o.fn.tooltip){o(this).find('[title]').tooltip({trigger:'hover'})};o(this).unblock();o(this).find('input:checkbox').iCheck({checkboxClass:'icheckbox_flat-blue'})},a=function(){var a=o('#dataTables-cobros'),n={'aoColumns':[{width:'10px'},{name:'serialNumber',title:'Número'},{name:'startAt',title:'Fecha'},{name:'provider',title:'Agencia'},{name:'providerReference',title:'Referencia'},{name:'clientNames',title:'Clientes'},{name:'serviceType',title:'Tipo de servicio'},{name:'price',title:'Importe'}],columnDefs:[{targets:[0,1,4,5,7],sortable:!1}],aaSorting:[[2,'asc']],searching:!1,serverSide:!0,processing:!1,ajax:{data:function(e){var t=[];o.each(o('#frmFilter').serializeArray(),function(o,e){t[e['name']]=e['value']});return o.extend(!0,e,t)},method:'GET',url:a.data('ajax-url')}};a.on('draw.dt',t).on('preDraw.dt',function(){o(this).block({'message':'Procesando...'})});e=a.dataTable(n)},n=function(){if(o.validator){o.validator.addMethod('validdecimal',function(o,e){return this.optional(e)||/^((.|,)\d{1,2}|\d+(|.(|\d{1,2})|,(\d{1,2})))$/.test(o)},'Valor no válido')}
else{console.log('Validator plugin not present')}},i=function(){App.Main.validate(o('.modal[data-for=cobrar-op] form'))},r=function(e){e.preventDefault();if(o('#dataTables-cobros').find('input:checkbox:checked').length==0){o('.modal[data-for=cobrar-error]').modal();return};var t=[];o('#dataTables-cobros').find('input:checkbox:checked').each(function(){t.push(this.value)});o('.modal[data-for=cobrar-op] .modal-body').empty().text('Cargando información de servicios seleccionados...');o('.modal[data-for=cobrar-op]').modal();o('.modal[data-for=cobrar-op] div.modal-body').load(o(this).attr('href'),{ids:t},i)},c=function(e){e.preventDefault();o(this).parents('.modal-content:first').find('form').submit();o(this).off('click').text('Guardando información...')},l=function(e){e.preventDefault();var a=o(this).data('url'),t=o('.modal[data-for=cobrar-op] form').clone();t.attr({action:a,method:'post',target:'_blank'}).appendTo(o('body')).submit();setTimeout(function(){t.remove()},100)},d=function(){o('.modal[data-for=cobrar-op] .btn-success').on('click',c);o('.modal[data-for=cobrar-op] .btn-print').on('click',l)},s=function(e){e.preventDefault();o('#dataTables-cobros input:checkbox').prop('checked',!0);o('#dataTables-cobros input:checkbox').iCheck('update')},f=function(e){e.preventDefault();o('#dataTables-cobros input:checkbox').prop('checked',!1);o('#dataTables-cobros input:checkbox').iCheck('update')},p=function(){o('#linkCobrar').on('click',r);o('#linkSelectAll').on('click',s);o('#linkSelectNone').on('click',f)},u=function(){o('#modal-historico button.btn-primary').on('click',function(e){e.preventDefault();o('#modal-historico .modal-body form').submit();o('#modal-historico').modal('hide')});o('#modal-historico select').select2({language:'./i18n/es',width:'style'})},b=function(){o('#frmFilter input.datepicker').on('change',function(){e.DataTable().draw()}).datepicker({autoclose:!0,clearBtn:!0,format:'dd/mm/yyyy'});o('#frmFilter select').on('change',function(){e.DataTable().draw()});o('#frmFilter input:text').on('keyup',function(){e.DataTable().draw()})};return{init:function(){a();p();d();n();u();b()}}}(jQuery));
