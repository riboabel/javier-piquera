...
else{console.log('Validator plugin not present')}},r=function(){a=App.Main.validate(e('form#reserva'),{rules:{'reserva[startAt]':'validdatetime','reserva[endAt]':'validdatetime endafterstart','reserva[pax]':{min:1}}});e('#reserva_startPlace, #reserva_endPlace').on('change',function(){e(this).valid()})},d=function(a){a.preventDefault();var r=e('#places-container'),s=r.data('prototype'),d=r.data('index'),i=e(s.replace(/__name__/g,d));r.data('index',d+1);r.append(i);i.find('select').select2(t());i.find('.select2-container').css('width','');i.find('.select2-selection').css('height','30px');i.find('.datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0});if(r.find('.item').length>1){console.log(i.prev().find('.datepicker input').val());i.find('.datepicker').datepicker('setDate',i.prev().find('.datepicker input').val())};i.find('button.btn-delete').on('click',n)},n=function(t){t.preventDefault();e(this).parents('.item:first').removeClass('item').fadeOut(function(){e(this).remove()})},s=function(){e('#places-container').data('index',e('#places-container .item').length);e('#linkAddPassingPlace').on('click',d);e('#places-container .datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0});e('#places-container').find('button.btn-delete').on('click',n);e('#places-container').find('select').select2(t());e('#places-container').find('.select2-selection').css('height','30px')},t=function(){return{ajax:{url:e('#reserva_startPlace').data('ajax'),dataType:'json',delay:250,data:function(e){return{q:e.term,page:e.page}}},language:'es',minimunInputLength:1,placeholder:'Seleccione un lugar',width:'resolve'}},o=function(){if(e.fn.select2){e('#reserva_startPlace, #reserva_endPlace').select2(t());e('.select2-container').css('width','')}
else{console.log('select2 plugin not present')}},c=function(){e('#reserva_isDriverConfirmed').iCheck({checkboxClass:'icheckbox_flat-blue'});e('.btn-test-printed-version').on('click',function(){var n=e(this).data('target').replace(/^\#/,''),a=CKEDITOR.instances[n].getData(),t=e('<form/>').appendTo(e('body')).attr({action:Routing.generate('app_reservas_testprintedversion'),method:'POST',target:'_blank'}).append(e('<input type="hidden" name="content"/>').val(a));t.submit();t.remove()})};return{init:function(){r();i();s();o();c()}}}(jQuery));
;App=typeof App!=='undefined'?App:{};App.Reservas=typeof App.Reservas!=='undefined'?App.Reservas:{};App.Reservas.Index=function(e){var a,t=function(t){t.preventDefault();e('#modalExecute').remove();var r=e('<div class="modal fade" id="modalExecute" data-backdrop="static"><div class="modal-dialog"><div class="modal-content"></div></div></div>'),n=function(e){r.modal('hide');var t=r.data('row');t.find('td:last').empty().text('Ejecutando...');a.DataTable().draw(!1)};r.data('row',e(this).closest('tr'));r.find('.modal-content').load(e(this).attr('href'),function(){r.find('form').ajaxForm({dataType:'json',success:n});r.modal()})},r=function(a){a.preventDefault();e('#modalExecute').remove();var t=e('<div class="modal fade" id="modalExecute" data-backdrop="static"><div class="modal-dialog"><div class="modal-content"/></div></div>'),r=function(e){t.modal('hide')};t.find('.modal-content').load(e(this).attr('href'),function(){t.find('form').ajaxForm({dataType:'json',success:r});t.modal()})},n=function(a){a.preventDefault();e('.modal[data-for=dataTables-reservas] button.btn-danger').data('url',e(a.currentTarget).attr('href'));e('.modal[data-for=dataTables-reservas]').modal()},i=function(t){t.preventDefault();var r=e(this).data('url');e('#dataTables-reservas').find('a[href="'+r+'"]').parents('td:first').empty().text('Eliminando...');e(this).parents('.modal:first').modal('hide');e.ajax(r,{method:'post',type:'json',success:function(e){a.DataTable().draw(!1)},error:function(){alert('Error ejecutando operación.');a.DataTable().draw(!1)}})},o=function(){e('.modal[data-for=dataTables-reservas]').find('button.btn-danger').on('click',i)},c=function(a){a.preventDefault();e('.modal[data-for=cancel-op]').find('button.btn-warning').data('url',e(this).attr('href'));e('.modal[data-for=cancel-op]').modal()},s=function(t){t.preventDefault();var r=e(this).data('url');e('#dataTables-reservas').find('a[href="'+r+'"]').parents('td:first').empty().text('Cancelando...');e(this).parents('.modal:first').modal('hide');e.ajax(r,{method:'post',type:'json',success:function(e){a.DataTable().draw(!1)},error:function(){alert('Error ejecutando operación.');a.DataTable().draw(!1)}})},d=function(){e('.modal[data-for=cancel-op]').find('button.btn-warning').on('click',s)},l=function(){e(this).block({message:'Procesando...'})},f=function(){e(this).find('[title]').tooltip({'trigger':'hover'});e(this).find('input:checkbox').iCheck({checkboxClass:'icheckbox_flat-blue'});e(this).unblock()},u=function(i){var o=e('#dataTables-reservas');o.on('click','.btn-delete',n);o.on('click','.btn-cancel',c);o.on('click','.btn-execute',t);o.on('click','.btn-edit-issues',r);o.on('click','.btn-driver-confirm',p);o.on('draw.dt',f);o.on('preDraw.dt',l);var s={'aoColumns':[{'name':'selected','sortable':!1,'searchable':!1},{'name':'state','bSortable':!1,'bSearchable':!1},{'name':'startAt'},{'name':'provider'},{'name':'serialNumber'},{'name':'providerReference'},{'name':'clientNames'},{'name':'pax','searchable':!1},{'name':'serviceType'},{'name':'driver',title:'Conductor'},{name:'guide',title:'Guía',searchable:!1,sortable:!1},{name:'issues',searchable:!1,sortable:!1},{bSortable:!1,bSearchable:!1,width:'140px'}],'aaSorting':[[2,'asc']],serverSide:!0,processing:!1,ajax:{data:function(a){var t=[];e.each(e('form#filter').serializeArray(),function(e,a){if(/\[\]$/.test(a['name'])){var r=a['name'].replace(/\[\]$/,'');if(!t[r]){t[r]=[]};t[r].push(a['value'])}
else{t[a['name']]=a['value']}});return e.extend(!0,a,t)},method:'POST',url:Routing.generate('app_reservas_getdata')}};e.extend(s,{oSearch:{'sSearch':i.search}});a=o.dataTable(s)},m=function(){if(e('.modal[data-for=flash]').length){e('.modal[data-for=flash]').modal()}},p=function(t){t.preventDefault();e(this).parents('td:first').empty().text('Confirmando...');e.ajax(e(this).attr('href'),{method:'post',success:function(){a.DataTable().draw(!1)}})},h=function(){e('#filter-form .datepicker').datepicker({format:'dd/mm/yyyy',autoclose:!0})},v=function(){h();e('#filter-form').find('input, select').on('change',function(){if(e(this).is('select[name="reserva_filter_form[isDriverAssigned][choice]"]')){if(e(this).val()==='with-drivers'){e('#filter-form [name="reserva_filter_form[isDriverAssigned][drivers][]"]').closest('div.row').show()}
else{e('#filter-form [name="reserva_filter_form[isDriverAssigned][drivers][]"]').closest('div.row').hide()}};a.DataTable().draw()});e('[name="reserva_filter_form[isDriverAssigned][drivers][]"], select[name="reserva_filter_form[serviceType][]"]','#filter-form').select2({width:'100%'})},b=function(t){t.preventDefault();if(a.find('input:checkbox:checked').length==0){return alert('Debe seleccionar registros para realizar esta operación')};var r=e('<form/>').attr({action:e(this).attr('href'),method:'post',target:'_blank'}).append(a.find('input:checkbox:checked').clone().attr('name','ids[]')).appendTo(e('body'));r.submit().remove()},k=function(t){t.preventDefault();if(a.find('input:checkbox:checked').length==0){return alert('Debe seleccionar registros para realizar esta operación')};var r=e('<form/>').attr({action:e(this).attr('href'),method:'post',target:'_blank'}).append(a.find('input:checkbox:checked').clone().attr('name','ids[]')).appendTo(e('body'));r.submit().remove()},x=function(){e('#link-select-all').on('click',function(e){e.preventDefault();a.find('input:checkbox').iCheck('check')});e('#link-select-none').on('click',function(e){e.preventDefault();a.find('input:checkbox').iCheck('uncheck')});e('a#linkPrintSelection').on('click',b);e('a#linkPrintSpecialReport').on('click',k)};return{init:function(e){u(e);o();d();v();x();m()}}}(jQuery);
